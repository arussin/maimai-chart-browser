...
(() => {
  'use strict';
  if (window.maimaiI18n) return;
  const catalogs = __MAIMAI_MESSAGES__;
  ...
  window.maimaiI18n=Object.freeze({text,literal,verbatim,parts,message,original,attribute,option,translate,searchTerms,staticText,controls,setLocale,negotiate,get locale(){return locale;}});
  document.documentElement.lang=locale;
