...
Use the linked implementation checkout when one was explicitly requested. Keep
canonical unpublished development-layout/retention changes out of product commits;
this implementation does not change the machine's cleanup or migration policy.
