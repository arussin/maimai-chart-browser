...
playerCore=Object.freeze({validPlayer,validate,structure,decode,encode,current,offer,validateOffer,needsUpdate,merge,reconcile,chartHistory,hash,digest,canonical,bounded,MAX_COMPRESSED,MAX_DECODED});
})();
