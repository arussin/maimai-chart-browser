...
export default defineConfig({
  testDir:'.',testMatch:['share-site.spec.js','localization.spec.js','standalone.spec.js','community.spec.js','analytics.spec.js','cloudflare-analytics.spec.js','stripe-support.spec.js','mai-notes.spec.js','performance.spec.js','progressive.spec.js','player-history.spec.js','player-sorting.spec.js','comparison-search.spec.js','registry.spec.js'],fullyParallel:true,workers:3,
