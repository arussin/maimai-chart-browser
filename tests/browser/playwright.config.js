...
export default defineConfig({
  testDir:'.',testMatch:['startup-interactions.spec.js','usage.spec.js','player-ranges.spec.js','player-results.spec.js','player-maishift-pilot.spec.js','player-maishift-browser.spec.js','player-maishift.spec.js','player-sources.spec.js','share-site.spec.js','localization.spec.js','standalone.spec.js','community.spec.js','analytics.spec.js','cloudflare-analytics.spec.js','stripe-support.spec.js','mai-notes.spec.js','performance.spec.js','progressive.spec.js','player-history.spec.js','player-sorting.spec.js','comparison-search.spec.js','registry.spec.js','seo-navigation.spec.js'],fullyParallel:true,workers:3,
