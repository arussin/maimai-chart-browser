...
export default defineConfig({
  testDir:'.',testMatch:['standalone.spec.js','community.spec.js','analytics.spec.js','cloudflare-analytics.spec.js','support.spec.js','mai-notes.spec.js','performance.spec.js','progressive.spec.js'],fullyParallel:true,workers:3,
